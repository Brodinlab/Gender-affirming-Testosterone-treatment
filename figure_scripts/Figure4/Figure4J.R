#Script to generate Figure4J in Lakshmikanth, Consiglio et al - Immune system adapaption to Gender affirming Testosterone Therapy
...
#Removal of Tregs
inds = rownames(seuratObj@meta.data[seuratObj@meta.data$celltype_sub %in% c('Treg'), ])
seuratObj <- seuratObj[, ! rownames(seuratObj@meta.data) %in% inds]

unique(seuratObj@meta.data$celltype_sub)
...
#Take the top 15 of pearson correlation coefficient
...
#ccolors <- colormap(colormap = colormaps$YIOrRd, nshades = length(target_color[[1]]))
#target_color$color_target_type <- ccolors
#monocyte = purple
#NK = #FF3300 (red)
#pDC = #3333FF (blue)
#CD4T = #339966 (green)
...
target_color$color_target_type <- c("purple", "purple", "purple", "#FF3300", "#3333FF", "#FF3300", "purple", "#339966", "purple","purple", 
                                    "#FF3300", "#339966", "#3333FF", "#339966", "#FF3300", "orange", "orange", 
                                    "#339966", "yellow", "purple","orange", "purple","#339966", "#339966", "purple","black", "#FF3300", "purple")
